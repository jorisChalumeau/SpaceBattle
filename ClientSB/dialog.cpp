...

{
    ...
    connect(ui->boutonEnvoyer, SIGNAL(clicked()), this, SLOT(buttonSendclicked()));
...
{
    mainW = new MainWindow(tcpSocket); // Be sure to destroy your window somewhere
    mainW->show();
}
